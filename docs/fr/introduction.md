...
### Widget de Feedback
:::doc-feedback{id="mon-tuto" title="Est-ce utile ?"}

### Tooltip de Texte
Utilisez les ==tooltips== pour expliquer des termes complexes : :::tooltip[Survolez-moi]{content="Ceci est une explication."}

---

## 6. Mathématiques (KaTeX)
